            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/stat/stats', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $stats->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
