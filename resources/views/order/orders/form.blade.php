...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group{{ $errors->has('client_id') ? 'has-error' : ''}}">
            ...
            {!! Form::select('client_id', $clients->count() == 1 ? $clients : $clients, isset($clients) ? $clients : [], $clients->count() > 1 ? ['class' => 'form-control chosen', 'multiple' => false, 'required' => 'required', 'placeholder' => 'Seleccionar Cliente'] : ['class' => 'form-control chosen', 'multiple' => false, 'required' => 'required']) !!}
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('date_delivery') ? 'has-error' : ''}}">
            {!! Form::label('date_delivery', 'Día de Entrega', ['class' => 'control-label']) !!}
            {!! Form::date('date_delivery', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    ...
    <!--<div class="col-md-4">
        <div class="form-group{{ $errors->has('date_pay') ? 'has-error' : ''}}">
            {!! Form::label('date_pay', 'Día de Pago', ['class' => 'control-label']) !!}
            {!! Form::date('date_pay', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('stats') ? ' has-error' : ''}}">
            ...
            {!! Form::select('stat_id', $stats, !empty($order) ? $order->stat_id : 3, ['class' => 'form-control', 'multiple' => false, 'required' => 'required']) !!}
...
<div class="row" >
    ...
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('cost') ? 'has-error' : ''}}">
            ...
            {!! Form::number('cost', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required', 'min'=>'1', 'onchange'=>'change_due()'] : ['class' => 'form-control', 'min'=>'1', 'onchange'=>'change_due()']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group{{ $errors->has('due') ? 'has-error' : ''}}">
            ...
            {!! Form::text('due', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required', 'min'=>'0'] : ['class' => 'form-control', 'min'=>'0']) !!}
     ...
     <div class="col-md-12 product_quantity" style="display: inline-flex; border-bottom: 1px solid white"> 
        <div class="col-md-5">
           <div class="form-group{{ $errors->has('product_id') ? 'has-error' : ''}}">
            ...
            {!! Form::select('product_id[]', $products->prepend('Seleccionar Producto'), isset($products) ? $products : [], ['class' => 'form-control chosen', 'multiple' => false, 'required' => 'required', 'onchange'=>'change_total()']) !!}
...
<div class="form-group{{ $errors->has('observations') ? 'has-error' : ''}}" style="margin-top: 15px;">
